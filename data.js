const courseData = [
  {
    ...
    assessments: ['Assignments', 'Quizzes', 'Research presentation'],
    resources: ['Lecture notes', 'Journal papers', 'Simulation toolkit']
  },
  {
    code: 'CS6380',
    ...
    assessments: ['Problem sets', 'Midterm exam', 'Mini project'],
    resources: ['Course slides', 'Reference books', 'Coding notebooks']
  },
  {
    code: 'CS5013',
  ...
  },
  {
    ...
    assessments: ['Lab reports', 'Case study', 'Final assessment'],
    resources: ['Security tools', 'Reports', 'Reference manuals']
  },
  {
    code: 'CS6666',
    ...
    assessments: ['Reading notes', 'Implementation task', 'Final project'],
    resources: ['Whitepapers', 'SDK guides', 'Demo repositories']
  }
];
